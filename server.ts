...
const META_FRAG = `fragment Meta on Metafield { id namespace key value type reference { ... on Metaobject { handle fields { key value } } } references(first: 10) { edges { node { ... on Metaobject { handle fields { key value } } } } } }`;
