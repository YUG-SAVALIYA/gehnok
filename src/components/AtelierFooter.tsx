...
export default function AtelierFooter({ onOpenPolicy, onNavigate }: AtelierFooterProps) {
  ...
  return (
    <footer className="bg-[#381932] text-[#FFFFFF] border-t border-[#FFFFFF]/20 pt-24 pb-16 font-sans">
      <div className="w-full px-4 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-[#FFFFFF]/10">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-xs leading-relaxed text-[#FFFFFF]/80 font-light max-w-sm font-sans tracking-wide">
            ...
            <div className="flex items-center space-x-3 text-[#FFFFFF] pt-2">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-8 text-xs">
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] tracking-[0.3em] uppercase font-bold text-[#FFFFFF] border-b border-[#FFFFFF]/10 pb-2 inline-block">
                Quick Links
              </h4>
              <ul className="space-y-4 text-[#FFFFFF]/80 font-medium text-[11px] tracking-wide uppercase font-sans">
          ...
          <div className="md:col-span-4 space-y-6">
            <h4 className="text-[10px] tracking-[0.3em] uppercase font-bold text-[#FFFFFF] flex items-center gap-2 border-b border-[#FFFFFF]/10 pb-2 inline-flex">
              <Mail size={12} className="text-[#FFFFFF] opacity-80" />
              Atelier Correspondence
            </h4>
            <p className="text-xs text-[#FFFFFF]/80 leading-relaxed font-light tracking-wide">
              Receive private invitations to seasonal collections, metallurgy briefings, and private exhibition viewings.
            </p>

            <form onSubmit={handleSubscribe} className="relative flex items-center mt-6 border-b border-[#FFFFFF]/30 pb-2">
              <input
                type="email"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                placeholder="Enter client email address..."
                className="w-full bg-transparent text-sm text-[#FFFFFF] placeholder-[#FFFFFF]/40 focus:outline-none tracking-wide font-sans"
                required
              />
              <button
                type="submit"
                className="absolute right-0 p-1 text-[#FFFFFF] hover:text-[#D4AF37] transition-colors"
            ...
            {subscribed && (
              <p className="text-[10px] text-[#FFFFFF]/80 italic font-mono animate-pulse mt-2 uppercase tracking-wider">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between text-[10px] text-[#FFFFFF]/60 gap-6 font-sans">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 font-bold uppercase tracking-wider">
            ...
            <span className="hidden sm:block text-[#FFFFFF]/20">|</span>
            <span className="hover:text-[#D4AF37] cursor-pointer transition-all">Security Protocol & Privacy</span>
          </div>

          {/* Hallmarking statement */}
          <p className="text-center md:text-right text-[9px] tracking-[0.2em] uppercase font-bold text-[#FFFFFF]/50 max-w-xl leading-relaxed">
